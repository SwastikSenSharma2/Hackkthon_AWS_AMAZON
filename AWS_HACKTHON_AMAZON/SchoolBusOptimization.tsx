      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-1" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
              Greenwood International School — Fleet Optimization
            </h1>
          ...
          <div className="p-3.5 rounded-2xl bg-white border border-slate-200 shadow-xs max-w-xs">
            ...
            <p className="text-xs text-slate-600 mt-0.5 leading-relaxed">
              38 buses concentrated on Varthur corridor during the same morning peak window.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-6">
          <div className="p-4 rounded-2xl bg-white border border-slate-200 shadow-xs">
            <span className="text-[11px] text-slate-500 font-semibold uppercase block">Route A (Varthur Main)</span>
          ...
          <div className="p-4 rounded-2xl bg-teal-50 border border-teal-200 shadow-xs">
            <span className="text-[11px] text-teal-800 font-semibold uppercase block">Route B (Gunjur Bypass)</span>
            ...
            <p className="text-[11px] text-teal-700 mt-0.5">Utilizes Sarjapur bypass (34% load)</p>
          </div>
